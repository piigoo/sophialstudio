    ...
    <div className={`menu-container ${props.showMenu}`}>
      ...
      <div className="menu-items">
        <ul>
          ...
          <li>
            <a href="#journey" onClick={props.toggleMenu}>
              JOURNEY
            </a>
          </li>
        </ul>
  ...
  return (
    <header id="welcome-section">
      ...
      <div className="container">
        <h1>
          <span className="line">Sophia's</span>
          <span className="line">Art practise</span>
          <span className="line">
            <span className="color">&</span> Journey.
          </span>
        </h1>
      ...
      <div className="wrapper">
        <article>
          ...
          <div className="desc full">
            <h4 className="subtitle">My name is Sophia.</h4>
            <p>
              Hi, I'm a 16 years old student currently studying in SCIE.
I’m an optimistic girl with tons of hobbies,
but what makes me Sophia is my passion for art and design.
            </p>
            <p>
              I really enjoy pretty things. I was always the "DT queen" in the class!
            </p>
          </div>
          <div className="title">
          ...
          <div className="desc">
            <h4 className="subtitle">I'm a designer.</h4>
            <p>
          ...
          <div className="desc">
            <h4 className="subtitle">Also an entrepreneur.</h4>
            <p>
